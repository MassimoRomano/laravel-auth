        ...
        <form action="{{ route('admin.projects.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" aria-describedby="titleHelper"
                    placeholder="Scrivi titolo" value="{{ old('title') }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('image') is-invalid @enderror" name="image" id="image"
                    aria-describedby="imageHelper" placeholder="Inserisci url image" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('project') is-invalid @enderror" name="project" id="project"
                    aria-describedby="projectHelper" placeholder="Inserisci link progetto" />
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" placeholder="scrivi una breve descrizione..." rows="5">{{ old('description') }}</textarea>
                @error('description')
                <div class="text-danger py-2">
                    {{$message}}
                </div>
